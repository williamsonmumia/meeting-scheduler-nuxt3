  ...
  <LandingContainer>
    <header class="flex flex-col lg:flex-row justify-between items-center my-5">
      ...
      <nav class="w-full lg:w-auto mt-2 lg:flex lg:mt-0" :class="{ block: open, hidden: !open }">
        ...
        <div class="lg:hidden flex flex-col sm:flex-row items-center gap-3 mt-3 w-full">
          <!-- Login Button -->
          <LandingLink to="/api/login" styleName="muted" size="md" class="w-full sm:w-auto">
            Log in
          </LandingLink>

          <!-- Signup Button (Primary Action) -->
          <LandingLink href="/api/register" styleName="primary" size="md" class="w-full sm:w-auto">
            Sign up
          </LandingLink>
        </div>
      </nav>
      <div>
        <div class="hidden lg:flex items-center gap-4">
          ...
          <LandingLink to="/api/register" external size="md">Sign up</LandingLink>
        </div>
      </div>
    </header>
  </LandingContainer>
